...
```bash
# POST /create
curl -X POST -H "Content-Type: application/json" -d '{"url":"https://shortlinks.dpdns.org/"}' https://shortlinks.dpdns.org/create

# 指定slug
curl -X POST -H "Content-Type: application/json" -d '{"url":"https://shortlinks.dpdns.org/","slug":"scxs"}' https://shortlinks.dpdns.org/create
